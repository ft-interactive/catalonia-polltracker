...
function averageData(allData){
  ...
  uniqueDates.forEach(date => {
    let pastPolls = allData
      ...
      // .filter(d => {
      //   let pscResult = d['parties']['psc'];
      //   console.log("PSC RESULT", pscResult);
      //   return typeof pscResult === 'number' && !Number.isNaN(pscResult);
      // });  //remove dud results at this stage by checking PSC result
