    ...
    Object.keys(allResults).forEach((partyKey, index, array) => {
      ...
      parent.select("g.linechart").append('text')
        ...
        function setYLabelPos(){
          if (index === (array.length - 1)) return labelPos + 20; //pull smallest party result down
          else if (index === (array.length - 2)) return labelPos + 30; //pull 2nd smallest party result down
